...
- Implementation unit id: `iu.rupify.domain-invariant-3.record-contract-dates`
- Issue slug: `iu-rupify-domain-invariant-3-record-contract-dates`
...
- Verification units: `vu.rupify.domain-invariant-3.record-contract-dates`
- Depends on: none
