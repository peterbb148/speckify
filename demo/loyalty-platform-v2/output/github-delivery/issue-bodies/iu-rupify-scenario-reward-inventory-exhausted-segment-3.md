...
- Implementation unit id: `iu.rupify.scenario-reward-inventory-exhausted.segment-3`
- Issue slug: `iu-rupify-scenario-reward-inventory-exhausted-segment-3`
...
- Verification units: `vu.rupify.scenario-reward-inventory-exhausted.segment-3`
- Depends on:
  - `iu.rupify.scenario-reward-inventory-exhausted.segment-2` (Implement scenario handling: Reward Inventory Exhausted segment 2)
