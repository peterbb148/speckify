...
- Implementation unit id: `iu.rupify.scenario-reward-inventory-exhausted.segment-1`
- Issue slug: `iu-rupify-scenario-reward-inventory-exhausted-segment-1`
...
- Verification units: `vu.rupify.scenario-reward-inventory-exhausted.segment-1`
- Depends on: none
...
- Intent: Confirm the scenario handling behaves correctly for reward inventory exhausted segment 1.
