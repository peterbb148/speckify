...
- Implementation unit id: `iu.rupify.scenario-reward-inventory-exhausted.segment-2`
- Issue slug: `iu-rupify-scenario-reward-inventory-exhausted-segment-2`
...
- Verification units: `vu.rupify.scenario-reward-inventory-exhausted.segment-2`
- Depends on:
  - `iu.rupify.scenario-reward-inventory-exhausted.segment-1` (Implement scenario handling: Reward Inventory Exhausted segment 1)
