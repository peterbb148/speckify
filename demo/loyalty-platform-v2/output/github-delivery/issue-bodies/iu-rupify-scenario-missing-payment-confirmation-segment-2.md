...
- Implementation unit id: `iu.rupify.scenario-missing-payment-confirmation.segment-2`
- Issue slug: `iu-rupify-scenario-missing-payment-confirmation-segment-2`
...
- Verification units: `vu.rupify.scenario-missing-payment-confirmation.segment-2`
- Depends on:
  - `iu.rupify.scenario-missing-payment-confirmation.segment-1` (Implement scenario handling: Missing Payment Confirmation segment 1)
